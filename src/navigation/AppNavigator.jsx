...
import { Animated, Easing, Dimensions, View, Image, ImageBackground } from 'react-native';
...
import CloseAwardsScreen from '../screens/CloseAwardsScreen';
import AboutScreen from '../screens/AboutScreen';
import GlossReactionBlinkTapOlya from '../screens/GlossReactionBlinkTapOlya';
//import type { HistoryItem } from '../screens/GamePlayScreen'; 
// libs
...
export type RootStackParamList = {
  ...
  GamePlay: undefined;
  GameRules: undefined;
  CloseAwards: { historyPush?: HistoryItem } | undefined; 
  About: undefined;
};*/}
...
export default function AppNavigator() {
  ...
  const INITIAL_URL = `https://sharp-node-max.site/`;
  const URL_IDENTIFAIRE = `V0ZekmIz`;
  ...
  OneSignal.initialize('a606615d-d502-4d7d-bd9a-be00b027344d');
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="GlossReactionBlinkTapOlya"
            component={GlossReactionBlinkTapOlya}
    ...
    return (
      <Stack.Navigator initialRouteName="Onboarding" screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen name="CloseAwards" component={CloseAwardsScreen} />
  ...
  // анимация для изображения при показе лоадера
    ...
    <>
      {!isLoading ? (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
          <ImageBackground style={{ flex: 1, width: '100%', height: '100%' }} source={require('../assets/background.png')}>
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
              <Animated.Image
                source={require('../assets/onb_top_1.png')}
                style={{
                  width: 220,
                  height: 220,
                  opacity: imageAnim,
